...
# This file is accessible as https://cdn.jsdelivr.net/gh/if1y/ScriptCN/multi-v2ray/go.sh
...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://ghproxy.com/https://github.com/$REPOS/releases/download/${NEW_VER}/${PACK_NAME}-linux-${VDIS}.zip"
